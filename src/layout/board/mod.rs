...
const ANON_FACES: [&str; 5] = ["(0_0)", "(O_O)", "(0_0)", "(o_o)", "(@_@)"];
...
fn dialog_variant_count(kind: DialogKind) -> usize {
    match kind {
...
fn dialog_message(kind: DialogKind, language: &str, variant: usize) -> &'static str {
